...
export const aboutMeData: AboutInfo = {
  statement:
    'SeBeom Lee is a Solutions Architect at AWS Korea with a deep passion for the current wave of AI and machine learning technologies, bridging the gap between cutting-edge innovation and practical cloud solutions.',
